package com.tridu33.jvm.reflect;
...
public class getClass4Methods {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        * */
        ...
        Class c3 = Class.forName("com.tridu33.jvm.reflect.Person");//指明包名
        System.out.println("方法三 : 调用Class的静态方法forName: "+c3.toString());

        // 方法四 ：通过类的加载器
        ClassLoader classLoader = Person.class.getClassLoader();
        Class c4 = classLoader.loadClass("com.tridu33.jvm.reflect.Person");
        ...
        // 等价于下面这两步
        Class c;
        c = Class.forName("com.tridu33.jvm.reflect.Person");
        //1、获取这个带有参数的构造器
